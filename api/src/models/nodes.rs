...
impl ::protobuf::Message for TimecodeOutputNodeConfig {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.control_id != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.control_id);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
        self.special_fields.cached_size().set(my_size as u32);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.control_id != 0 {
            os.write_uint32(2, self.control_id)?;
        }
        os.write_unknown_fields(self.special_fields.unknown_fields())?;
        ::std::result::Result::Ok(())
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01(\x0e2\x1c.mizer.nodes.ChannelProtocolR\x08protocol\"\xbb\t\n\x04Nod\
    ...
    odeConfigH\0R\x14timecodeOutputConfigB\x06\n\x04type\"\x87\x02\n\x14Osci\
    llatorNodeConfig\x12D\n\x04type\x18\x01\x20\x01(\x0e20.mizer.nodes.Oscil\
    latorNodeConfig.OscillatorTypeR\x04type\x12\x14\n\x05ratio\x18\x02\x20\
    ...
    k\x18\x01\x20\x01(\x01R\x06attack\x12\x14\n\x05decay\x18\x02\x20\x01(\
    \x01R\x05decay\x12\x18\n\x07sustain\x18\x03\x20\x01(\x01R\x07sustain\x12\
    ...
    \x12E\n\x07pattern\x18\x01\x20\x01(\x0e2+.mizer.nodes.PixelPatternNodeCo\
    ...
    K\n\x0bnoteBinding\x18\x02\x20\x01(\x0b2'.mizer.nodes.MidiNodeConfig.Not\
    eBindingH\0R\x0bnoteBinding\x12T\n\x0econtrolBinding\x18\x03\x20\x01(\
    \x0b2*.mizer.nodes.MidiNodeConfig.ControlBindingH\0R\x0econtrolBinding\
    \x1a\xd7\x01\n\x0bNoteBinding\x12\x18\n\x07channel\x18\x01\x20\x01(\rR\
    \x07channel\x12D\n\x04type\x18\x02\x20\x01(\x0e20.mizer.nodes.MidiNodeCo\
    nfig.NoteBinding.MidiTypeR\x04type\x12\x12\n\x04port\x18\x03\x20\x01(\rR\
    \x04port\x12\x1c\n\trangeFrom\x18\x04\x20\x01(\rR\trangeFrom\x12\x18\n\
    \x07rangeTo\x18\x05\x20\x01(\rR\x07rangeTo\"\x1c\n\x08MidiType\x12\x06\n\
    \x02CC\x10\0\x12\x08\n\x04Note\x10\x01\x1a>\n\x0eControlBinding\x12\x12\
    \n\x04page\x18\x01\x20\x01(\tR\x04page\x12\x18\n\x07control\x18\x02\x20\
    ...
    \x18\x02\x20\x01(\tR\x04path\x12K\n\x0cargumentType\x18\x03\x20\x01(\x0e\
    2'.mizer.nodes.OscNodeConfig.ArgumentTypeR\x0cargumentType\x12(\n\x0fonl\
    yEmitChanges\x18\x04\x20\x01(\x08R\x0fonlyEmitChanges\"M\n\x0cArgumentTy\
    ...
    \x04mode\x18\x01\x20\x01(\x0e2&.mizer.nodes.MergeNodeConfig.MergeModeR\
