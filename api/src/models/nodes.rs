...
impl ::protobuf::ProtobufEnum for Node_NodeType {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<Node_NodeType> {
        match value {
            ...
            63 => ::std::option::Option::Some(Node_NodeType::VideoPixelFile),
...
pub enum NodeConfig_oneof_type {
    ...
    videoPixelFileConfig(VideoPixelFileNodeConfig),
}
...
impl NodeConfig {
    ...
    // .mizer.ValueNodeConfig valueConfig = 51;
    ...
    // .mizer.PlanScreenNodeConfig planScreenConfig = 52;
    ...
    // .mizer.VideoPixelFileNodeConfig videoPixelFileConfig = 53;


    pub fn get_videoPixelFileConfig(&self) -> &VideoPixelFileNodeConfig {
        match self.field_type {
            ::std::option::Option::Some(NodeConfig_oneof_type::videoPixelFileConfig(ref v)) => v,
            _ => <VideoPixelFileNodeConfig as ::protobuf::Message>::default_instance(),
        }
    }
    pub fn clear_videoPixelFileConfig(&mut self) {
        self.field_type = ::std::option::Option::None;
    }

    pub fn has_videoPixelFileConfig(&self) -> bool {
        match self.field_type {
            ::std::option::Option::Some(NodeConfig_oneof_type::videoPixelFileConfig(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_videoPixelFileConfig(&mut self, v: VideoPixelFileNodeConfig) {
        self.field_type = ::std::option::Option::Some(NodeConfig_oneof_type::videoPixelFileConfig(v))
    }

    // Mutable pointer to the field.
    pub fn mut_videoPixelFileConfig(&mut self) -> &mut VideoPixelFileNodeConfig {
        if let ::std::option::Option::Some(NodeConfig_oneof_type::videoPixelFileConfig(_)) = self.field_type {
        } else {
            self.field_type = ::std::option::Option::Some(NodeConfig_oneof_type::videoPixelFileConfig(VideoPixelFileNodeConfig::new()));
        }
        match self.field_type {
            ::std::option::Option::Some(NodeConfig_oneof_type::videoPixelFileConfig(ref mut v)) => v,
            _ => panic!(),
        }
    }

    // Take field
    pub fn take_videoPixelFileConfig(&mut self) -> VideoPixelFileNodeConfig {
        if self.has_videoPixelFileConfig() {
            match self.field_type.take() {
                ::std::option::Option::Some(NodeConfig_oneof_type::videoPixelFileConfig(v)) => v,
                _ => panic!(),
            }
        } else {
            VideoPixelFileNodeConfig::new()
        }
    }
}
...
impl ::protobuf::Message for NodeConfig {
    fn is_initialized(&self) -> bool {
        ...
        if let Some(NodeConfig_oneof_type::videoPixelFileConfig(ref v)) = self.field_type {
            if !v.is_initialized() {
                return false;
            }
        }
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                53 => {
                    ...
                    self.field_type = ::std::option::Option::Some(NodeConfig_oneof_type::videoPixelFileConfig(is.read_message()?));
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let ::std::option::Option::Some(ref v) = self.field_type {
            match v {
                ...
                &NodeConfig_oneof_type::videoPixelFileConfig(ref v) => {
                    let len = v.compute_size();
                    my_size += 2 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
                },
            };
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_singular_message_accessor::<_, VideoPixelFileNodeConfig>(
                "videoPixelFileConfig",
                NodeConfig::has_videoPixelFileConfig,
                NodeConfig::get_videoPixelFileConfig,
            ));
...
#[derive(PartialEq,Clone,Default)]
#[cfg_attr(feature = "with-serde", derive(::serde::Serialize, ::serde::Deserialize))]
pub struct VideoPixelFileNodeConfig {
    // message fields
...
impl<'a> ::std::default::Default for &'a VideoPixelFileNodeConfig {
    fn default() -> &'a VideoPixelFileNodeConfig {
        <VideoPixelFileNodeConfig as ::protobuf::Message>::default_instance()
    }
}

impl VideoPixelFileNodeConfig {
    pub fn new() -> VideoPixelFileNodeConfig {
        ::std::default::Default::default()
    }
...
impl ::protobuf::Message for VideoPixelFileNodeConfig {
    fn is_initialized(&self) -> bool {
        true
    }
    ...
    fn new() -> VideoPixelFileNodeConfig {
        VideoPixelFileNodeConfig::new()
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "file_path",
                |m: &VideoPixelFileNodeConfig| { &m.file_path },
                |m: &mut VideoPixelFileNodeConfig| { &mut m.file_path },
            ));
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<VideoPixelFileNodeConfig>(
                "VideoPixelFileNodeConfig",
                fields,
                file_descriptor_proto()
            )
        })
    ...
    fn default_instance() -> &'static VideoPixelFileNodeConfig {
        static instance: ::protobuf::rt::LazyV2<VideoPixelFileNodeConfig> = ::protobuf::rt::LazyV2::INIT;
        instance.get(VideoPixelFileNodeConfig::new)
    }
}

impl ::protobuf::Clear for VideoPixelFileNodeConfig {
    fn clear(&mut self) {
        self.file_path.clear();
        self.unknown_fields.clear();
    }
...
impl ::std::fmt::Debug for VideoPixelFileNodeConfig {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for VideoPixelFileNodeConfig {
    fn as_ref(&self) -> ::protobuf::reflect::ReflectValueRef {
        ::protobuf::reflect::ReflectValueRef::Message(self)
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x20\x01(\x0e2\x16.mizer.ChannelProtocolR\x08protocol\"\xf8\x07\n\x04Nod\
    ...
    \x18\x07\x20\x01(\x0b2\x11.mizer.NodeConfigR\x06config\"\xff\x04\n\x08No\
    ...
    =\x12\x0e\n\nPlanScreen\x10>\x12\x12\n\x0eVideoPixelFile\x10?\"Q\n\x0fNo\
    dePreviewType\x12\x0b\n\x07History\x10\0\x12\x0c\n\x08Waveform\x10\x01\
    \x12\x0c\n\x08Multiple\x10\x02\x12\x0b\n\x07Texture\x10\x03\x12\x08\n\
    \x04None\x10\x04\"\xf1\x17\n\nNodeConfig\x12I\n\x10oscillatorConfig\x18\
    \n\x20\x01(\x0b2\x1b.mizer.OscillatorNodeConfigH\0R\x10oscillatorConfig\
    \x12F\n\x0fscriptingConfig\x18\x0b\x20\x01(\x0b2\x1a.mizer.ScriptingNode\
    ConfigH\0R\x0fscriptingConfig\x12C\n\x0esequenceConfig\x18\x0c\x20\x01(\
    \x0b2\x19.mizer.SequenceNodeConfigH\0R\x0esequenceConfig\x12:\n\x0bclock\
    Config\x18\r\x20\x01(\x0b2\x16.mizer.ClockNodeConfigH\0R\x0bclockConfig\
    \x12@\n\rfixtureConfig\x18\x0e\x20\x01(\x0b2\x18.mizer.FixtureNodeConfig\
    H\0R\rfixtureConfig\x12=\n\x0cbuttonConfig\x18\x0f\x20\x01(\x0b2\x17.miz\
    er.ButtonNodeConfigH\0R\x0cbuttonConfig\x12:\n\x0bfaderConfig\x18\x10\
    \x20\x01(\x0b2\x16.mizer.FaderNodeConfigH\0R\x0bfaderConfig\x12C\n\x0eil\
    ...
    \x0b2\x1a.mizer.DmxOutputNodeConfigH\0R\x0fdmxOutputConfig\x12A\n\x0fmid\
    iInputConfig\x18\x16\x20\x01(\x0b2\x15.mizer.MidiNodeConfigH\0R\x0fmidiI\
    nputConfig\x12C\n\x10midiOutputConfig\x18\x17\x20\x01(\x0b2\x15.mizer.Mi\
    diNodeConfigH\0R\x10midiOutputConfig\x12F\n\x0fopcOutputConfig\x18\x18\
    \x20\x01(\x0b2\x1a.mizer.OpcOutputNodeConfigH\0R\x0fopcOutputConfig\x12>\
    \n\x0eoscInputConfig\x18\x19\x20\x01(\x0b2\x14.mizer.OscNodeConfigH\0R\
    \x0eoscInputConfig\x12@\n\x0foscOutputConfig\x18\x1a\x20\x01(\x0b2\x14.m\
    izer.OscNodeConfigH\0R\x0foscOutputConfig\x12^\n\x17videoColorBalanceCon\
    fig\x18\x1b\x20\x01(\x0b2\".mizer.VideoColorBalanceNodeConfigH\0R\x17vid\
    eoColorBalanceConfig\x12L\n\x11videoEffectConfig\x18\x1c\x20\x01(\x0b2\
    \x1c.mizer.VideoEffectNodeConfigH\0R\x11videoEffectConfig\x12F\n\x0fvide\
    oFileConfig\x18\x1d\x20\x01(\x0b2\x1a.mizer.VideoFileNodeConfigH\0R\x0fv\
    ideoFileConfig\x12L\n\x11videoOutputConfig\x18\x1e\x20\x01(\x0b2\x1c.miz\
    er.VideoOutputNodeConfigH\0R\x11videoOutputConfig\x12U\n\x14videoTransfo\
    rmConfig\x18\x1f\x20\x01(\x0b2\x1f.mizer.VideoTransformNodeConfigH\0R\
    \x14videoTransformConfig\x12=\n\x0cselectConfig\x18\x20\x20\x01(\x0b2\
    \x17.mizer.SelectNodeConfigH\0R\x0cselectConfig\x12:\n\x0bmergeConfig\
    \x18!\x20\x01(\x0b2\x16.mizer.MergeNodeConfigH\0R\x0bmergeConfig\x12C\n\
    \x0eenvelopeConfig\x18\"\x20\x01(\x0b2\x19.mizer.EnvelopeNodeConfigH\0R\
    \x0eenvelopeConfig\x12F\n\x0fsequencerConfig\x18#\x20\x01(\x0b2\x1a.mize\
    r.SequencerNodeConfigH\0R\x0fsequencerConfig\x12I\n\x10programmerConfig\
    ...
    \x20\x01(\x0b2\x1a.mizer.MqttInputNodeConfigH\0R\x0fmqttInputConfig\x12I\
    \n\x10mqttOutputConfig\x180\x20\x01(\x0b2\x1b.mizer.MqttOutputNodeConfig\
    H\0R\x10mqttOutputConfig\x12O\n\x12numberToDataConfig\x181\x20\x01(\x0b2\
    \x1d.mizer.NumberToDataNodeConfigH\0R\x12numberToDataConfig\x12O\n\x12da\
    taToNumberConfig\x182\x20\x01(\x0b2\x1d.mizer.DataToNumberNodeConfigH\0R\
    \x12dataToNumberConfig\x12:\n\x0bvalueConfig\x183\x20\x01(\x0b2\x16.mize\
    r.ValueNodeConfigH\0R\x0bvalueConfig\x12I\n\x10planScreenConfig\x184\x20\
    \x01(\x0b2\x1b.mizer.PlanScreenNodeConfigH\0R\x10planScreenConfig\x12U\n\
    \x14videoPixelFileConfig\x185\x20\x01(\x0b2\x1f.mizer.VideoPixelFileNode\
    ConfigH\0R\x14videoPixelFileConfigB\x06\n\x04type\"\x81\x02\n\x14Oscilla\
    torNodeConfig\x12>\n\x04type\x18\x01\x20\x01(\x0e2*.mizer.OscillatorNode\
    Config.OscillatorTypeR\x04type\x12\x14\n\x05ratio\x18\x02\x20\x01(\x01R\
    \x05ratio\x12\x10\n\x03max\x18\x03\x20\x01(\x01R\x03max\x12\x10\n\x03min\
    \x18\x04\x20\x01(\x01R\x03min\x12\x16\n\x06offset\x18\x05\x20\x01(\x01R\
    ...
    \x12SequenceNodeConfig\x12<\n\x05steps\x18\x01\x20\x03(\x0b2&.mizer.Sequ\
    enceNodeConfig.SequenceStepR\x05steps\x1aL\n\x0cSequenceStep\x12\x12\n\
    ...
    en_id\x18\x02\x20\x01(\rR\x08screenId\"7\n\x18VideoPixelFileNodeConfig\
    \x12\x1b\n\tfile_path\x18\x01\x20\x01(\tR\x08filePath\"*\n\x0cNodePositi\
    ...
    \x12\x16.mizer.ShowNodeRequest\x1a\x17.mizer.ShowNodeResponse\"\0\x12;\n\
    \rDuplicateNode\x12\x1b.mizer.DuplicateNodeRequest\x1a\x0b.mizer.Node\"\
    \0b\x06proto3\
";
