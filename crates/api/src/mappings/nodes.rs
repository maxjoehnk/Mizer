...
impl From<NodeType> for node::NodeType {
    fn from(node: NodeType) -> Self {
        match node {
            ...
            NodeType::ImageFile => node::NodeType::ImageFile,
            ...
            NodeType::ColorToHsv => node::NodeType::ColorToHsv,
...
impl From<node::NodeType> for NodeType {
    fn from(node: node::NodeType) -> Self {
        match node {
            ...
            node::NodeType::ImageFile => NodeType::ImageFile,
            ...
            node::NodeType::ColorToHsv => NodeType::ColorToHsv,
