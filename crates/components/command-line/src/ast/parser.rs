...
pub fn parse<TContext: CommandLineContext>(
    ...
    match tokens.slice() {
        ...
        | [Token::Action(Action::Select), Token::Value(ref value)]
        ...
        [Token::Operator(Operator::At), Token::Full]
        ...
        | [Token::Action(Action::Write), Token::Operator(Operator::At), Token::Value(ValueToken::Number(value))] => {
            Ok(ast::Write {
                target_type: ast::Fixtures,
                target_entity: ast::ActiveSelection,
        ...
        [Token::Range(ref from, ref to), Token::Operator(Operator::At), Token::Value(ValueToken::Number(value))] => {
            Ok(ast::Write {
                target_type: ast::Fixtures,
                target_entity: ast::Range {
                    from: from.as_id()?,
        ...
        .boxed()),
        [Token::Range(ref from, ref to), Token::Operator(Operator::At), Token::Full] => {
            Ok(ast::Write {
                target_type: ast::Fixtures,
                target_entity: ast::Range {
                    from: from.as_id()?,
