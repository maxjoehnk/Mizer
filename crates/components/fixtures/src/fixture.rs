...
pub use crate::fixture_configuration::{ChannelLimit, FixtureConfiguration};
...
impl IFixtureMut for Fixture {
    fn write_fader_control_with_timings<TValue: Into<RawChannelValue> + Copy>(
        &mut self,
...
pub trait IFixtureMut: IFixture {
    fn write_fader_control<TValue: Into<RawChannelValue> + Copy>(
        &mut self,
        control: FixtureFaderControl,
        value: TValue,
        priority: FixturePriority,
