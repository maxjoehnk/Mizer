...
pub use mizer_injector::{Inject, InjectMut, Injector, InjectionScope, BorrowedMut, Borrowed};
...
pub trait Processor {
    ...
    fn pre_process(&mut self, _injector: &InjectionScope, _frame: ClockFrame, _fps: f64) {}
    fn process(&mut self, _injector: &InjectionScope, _frame: ClockFrame) {}
    fn post_process(&mut self, _injector: &InjectionScope, _frame: ClockFrame) {}
}
