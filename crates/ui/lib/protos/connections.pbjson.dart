...
final $typed_data.Uint8List monitorOscResponseDescriptor = $convert.base64Decode('');
...
const Connection$json = const {
  ...
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '10': 'name'},
    const {'1': 'dmx', '3': 10, '4': 1, '5': 11, '6': '.mizer.connections.DmxConnection', '9': 0, '10': 'dmx'},
    const {'1': 'midi', '3': 11, '4': 1, '5': 11, '6': '.mizer.connections.MidiConnection', '9': 0, '10': 'midi'},
    const {'1': 'osc', '3': 12, '4': 1, '5': 11, '6': '.mizer.connections.OscConnection', '9': 0, '10': 'osc'},
    const {'1': 'pro_dj_link', '3': 13, '4': 1, '5': 11, '6': '.mizer.connections.ProDjLinkConnection', '9': 0, '10': 'proDjLink'},
...
final $typed_data.Uint8List connectionDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use dmxConnectionDescriptor instead')
const DmxConnection$json = const {
  '1': 'DmxConnection',
  '2': const [
    const {'1': 'output_id', '3': 1, '4': 1, '5': 9, '10': 'outputId'},
    const {'1': 'artnet', '3': 3, '4': 1, '5': 11, '6': '.mizer.connections.ArtnetConfig', '9': 0, '10': 'artnet'},
...
final $typed_data.Uint8List dmxConnectionDescriptor = $convert.base64Decode('Cg1EbXhDb25uZWN0aW9uEhsKCW91dHB1dF9pZBgBIAEoCVIIb3V0cHV0SWQSOQoGYXJ0bmV0GAMgASgLMh8ubWl6ZXIuY29ubmVjdGlvbnMuQXJ0bmV0Q29uZmlnSABSBmFydG5ldBIzCgRzYWNuGAQgASgLMh0ubWl6ZXIuY29ubmVjdGlvbnMuU2FjbkNvbmZpZ0gAUgRzYWNuQggKBmNvbmZpZw==');
...
final $typed_data.Uint8List proDjLinkConnectionDescriptor = $convert.base64Decode('ChNQcm9EakxpbmtDb25uZWN0aW9uEhgKB2FkZHJlc3MYASABKAlSB2FkZHJlc3MSFAoFbW9kZWwYAiABKAlSBW1vZGVsEiMKDXBsYXllcl9udW1iZXIYAyABKA1SDHBsYXllck51bWJlchI6CghwbGF5YmFjaxgFIAEoCzIeLm1pemVyLmNvbm5lY3Rpb25zLkNkalBsYXliYWNrUghwbGF5YmFjaw==');
...
const ConfigureConnectionRequest$json = const {
  ...
  '2': const [
    const {'1': 'dmx', '3': 1, '4': 1, '5': 11, '6': '.mizer.connections.DmxConnection', '9': 0, '10': 'dmx'},
...
final $typed_data.Uint8List configureConnectionRequestDescriptor = $convert.base64Decode('');
