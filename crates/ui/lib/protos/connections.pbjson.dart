...
const Connection$json = const {
  ...
  '2': const [
    ...
    const {'1': 'webcam', '3': 19, '4': 1, '5': 11, '6': '.mizer.WebcamConnection', '9': 0, '10': 'webcam'},
  ],
  '8': const [
    const {'1': 'connection'},
  ],
...
final $typed_data.Uint8List midiDeviceProfileDescriptor = $convert.base64Decode('');
