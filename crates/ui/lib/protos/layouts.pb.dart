...
class DuplicateLayoutRequest extends $pb.GeneratedMessage {
  factory DuplicateLayoutRequest({
    $core.String? id,
    $core.String? name,
  }) {
    final $result = create();
  ...
  DuplicateLayoutRequest._() : super();
  factory DuplicateLayoutRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory DuplicateLayoutRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DuplicateLayoutRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'mizer.layouts'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..aOS(2, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  DuplicateLayoutRequest clone() => DuplicateLayoutRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DuplicateLayoutRequest copyWith(void Function(DuplicateLayoutRequest) updates) => super.copyWith((message) => updates(message as DuplicateLayoutRequest)) as DuplicateLayoutRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static DuplicateLayoutRequest create() => DuplicateLayoutRequest._();
  DuplicateLayoutRequest createEmptyInstance() => create();
  static $pb.PbList<DuplicateLayoutRequest> createRepeated() => $pb.PbList<DuplicateLayoutRequest>();
  @$core.pragma('dart2js:noInline')
  static DuplicateLayoutRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<DuplicateLayoutRequest>(create);
  static DuplicateLayoutRequest? _defaultInstance;
...
class BindHotkeyRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BindHotkeyRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'mizer.layouts'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'layoutId')
    ..aOS(2, _omitFieldNames ? '' : 'controlId')
    ..aOS(3, _omitFieldNames ? '' : 'hotkey')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BindHotkeyRequest copyWith(void Function(BindHotkeyRequest) updates) => super.copyWith((message) => updates(message as BindHotkeyRequest)) as BindHotkeyRequest;
