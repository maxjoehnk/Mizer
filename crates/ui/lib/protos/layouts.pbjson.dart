...
final $typed_data.Uint8List controlTypeDescriptor = $convert.base64Decode(
    ...
    'MSCQoFTEFCRUwQBBIMCghUSU1FQ09ERRAFEhIKDlNURVBfU0VRVUVOQ0VSEAY=');
...
@$core.Deprecated('Use duplicateLayoutRequestDescriptor instead')
const DuplicateLayoutRequest$json = {
  '1': 'DuplicateLayoutRequest',
  '2': [
    {'1': 'id', '3': 1, '4': 1, '5': 9, '10': 'id'},
    {'1': 'name', '3': 2, '4': 1, '5': 9, '10': 'name'},
  ],
...
/// Descriptor for `DuplicateLayoutRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List duplicateLayoutRequestDescriptor = $convert.base64Decode(
    'ChZEdXBsaWNhdGVMYXlvdXRSZXF1ZXN0Eg4KAmlkGAEgASgJUgJpZBISCgRuYW1lGAIgASgJUg'
    'RuYW1l');
...
const BindHotkeyRequest$json = {
  '1': 'BindHotkeyRequest',
  '2': [
    {'1': 'layout_id', '3': 1, '4': 1, '5': 9, '10': 'layoutId'},
    {'1': 'control_id', '3': 2, '4': 1, '5': 9, '10': 'controlId'},
    {'1': 'hotkey', '3': 3, '4': 1, '5': 9, '10': 'hotkey'},
  ],
};

/// Descriptor for `BindHotkeyRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List bindHotkeyRequestDescriptor = $convert.base64Decode(
    'ChFCaW5kSG90a2V5UmVxdWVzdBIbCglsYXlvdXRfaWQYASABKAlSCGxheW91dElkEh0KCmNvbn'
    'Ryb2xfaWQYAiABKAlSCWNvbnRyb2xJZBIWCgZob3RrZXkYAyABKAlSBmhvdGtleQ==');
...
const LayoutControl$json = {
  ...
  '2': [
    ...
    {'1': 'hotkey', '3': 11, '4': 1, '5': 9, '9': 1, '10': 'hotkey', '17': true},
  ],
...
final $typed_data.Uint8List layoutControlDescriptor = $convert.base64Decode(
    ...
    'bC5QcmVzZXRDb250cm9sVHlwZUgAUgZwcmVzZXQSGwoGaG90a2V5GAsgASgJSAFSBmhvdGtleY'
    'gBARolCg9Ob2RlQ29udHJvbFR5cGUSEgoEcGF0aBgBIAEoCVIEcGF0aBo3ChRTZXF1ZW5jZXJD'
    'b250cm9sVHlwZRIfCgtzZXF1ZW5jZV9pZBgBIAEoDVIKc2VxdWVuY2VJZBotChBHcm91cENvbn'
    'Ryb2xUeXBlEhkKCGdyb3VwX2lkGAEgASgNUgdncm91cElkGkwKEVByZXNldENvbnRyb2xUeXBl'
    'EjcKCXByZXNldF9pZBgBIAEoCzIaLm1pemVyLnByb2dyYW1tZXIuUHJlc2V0SWRSCHByZXNldE'
    'lkQg4KDGNvbnRyb2xfdHlwZUIJCgdfaG90a2V5');
