...
final $typed_data.Uint8List nodeCategoryDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List channelProtocolDescriptor = $convert.base64Decode(
    'Cg9DaGFubmVsUHJvdG9jb2wSCgoGU0lOR0xFEAASCQoFTVVMVEkQARILCgdURVhUVVJFEAISCgoGVkVDVE9SEAMSCQoFTEFTRVIQBBIICgRQT0xZEAUSCAoEREFUQRAGEgwKCE1BVEVSSUFMEAcSCQoFQ09MT1IQCRIJCgVDTE9DSxAK');
...
final $typed_data.Uint8List addNodeRequestDescriptor = $convert.base64Decode(
    'Cg5BZGROb2RlUmVxdWVzdBIuCgR0eXBlGAEgASgOMhoubWl6ZXIubm9kZXMuTm9kZS5Ob2RlVHlwZVIEdHlwZRI1Cghwb3NpdGlvbhgCIAEoCzIZLm1pemVyLm5vZGVzLk5vZGVQb3NpdGlvblIIcG9zaXRpb24SGwoGcGFyZW50GAMgASgJSABSBnBhcmVudIgBAUIJCgdfcGFyZW50');
...
final $typed_data.Uint8List duplicateNodeRequestDescriptor = $convert.base64Decode(
    'ChREdXBsaWNhdGVOb2RlUmVxdWVzdBISCgRwYXRoGAEgASgJUgRwYXRoEhsKBnBhcmVudBgCIAEoCUgAUgZwYXJlbnSIAQFCCQoHX3BhcmVudA==');
...
final $typed_data.Uint8List writeControlDescriptor = $convert.base64Decode(
    'CgxXcml0ZUNvbnRyb2wSEgoEcGF0aBgBIAEoCVIEcGF0aBISCgRwb3J0GAIgASgJUgRwb3J0EhQKBXZhbHVlGAMgASgBUgV2YWx1ZQ==');
...
final $typed_data.Uint8List updateNodeSettingRequestDescriptor = $convert.base64Decode(
    'ChhVcGRhdGVOb2RlU2V0dGluZ1JlcXVlc3QSEgoEcGF0aBgBIAEoCVIEcGF0aBIyCgdzZXR0aW5nGAIgASgLMhgubWl6ZXIubm9kZXMuTm9kZVNldHRpbmdSB3NldHRpbmc=');
...
final $typed_data.Uint8List moveNodeRequestDescriptor = $convert.base64Decode(
    'Cg9Nb3ZlTm9kZVJlcXVlc3QSEgoEcGF0aBgBIAEoCVIEcGF0aBI1Cghwb3NpdGlvbhgCIAEoCzIZLm1pemVyLm5vZGVzLk5vZGVQb3NpdGlvblIIcG9zaXRpb24=');
...
final $typed_data.Uint8List showNodeRequestDescriptor = $convert.base64Decode(
    'Cg9TaG93Tm9kZVJlcXVlc3QSEgoEcGF0aBgBIAEoCVIEcGF0aBI1Cghwb3NpdGlvbhgCIAEoCzIZLm1pemVyLm5vZGVzLk5vZGVQb3NpdGlvblIIcG9zaXRpb24SGwoGcGFyZW50GAMgASgJSABSBnBhcmVudIgBAUIJCgdfcGFyZW50');
...
final $typed_data.Uint8List renameNodeRequestDescriptor = $convert.base64Decode(
    'ChFSZW5hbWVOb2RlUmVxdWVzdBISCgRwYXRoGAEgASgJUgRwYXRoEhkKCG5ld19uYW1lGAIgASgJUgduZXdOYW1l');
...
final $typed_data.Uint8List groupNodesRequestDescriptor = $convert.base64Decode(
    'ChFHcm91cE5vZGVzUmVxdWVzdBIUCgVub2RlcxgBIAMoCVIFbm9kZXMSGwoGcGFyZW50GAIgASgJSABSBnBhcmVudIgBAUIJCgdfcGFyZW50');
...
final $typed_data.Uint8List deleteNodeRequestDescriptor =
    $convert.base64Decode('ChFEZWxldGVOb2RlUmVxdWVzdBISCgRwYXRoGAEgASgJUgRwYXRo');
...
final $typed_data.Uint8List hideNodeRequestDescriptor =
    $convert.base64Decode('Cg9IaWRlTm9kZVJlcXVlc3QSEgoEcGF0aBgBIAEoCVIEcGF0aA==');
...
final $typed_data.Uint8List nodesDescriptor = $convert.base64Decode(
    'CgVOb2RlcxInCgVub2RlcxgBIAMoCzIRLm1pemVyLm5vZGVzLk5vZGVSBW5vZGVzEjcKCGNoYW5uZWxzGAIgAygLMhsubWl6ZXIubm9kZXMuTm9kZUNvbm5lY3Rpb25SCGNoYW5uZWxzEi4KCWFsbF9ub2RlcxgDIAMoCzIRLm1pemVyLm5vZGVzLk5vZGVSCGFsbE5vZGVz');
...
final $typed_data.Uint8List availableNodesDescriptor = $convert.base64Decode(
    'Cg5BdmFpbGFibGVOb2RlcxIwCgVub2RlcxgBIAMoCzIaLm1pemVyLm5vZGVzLkF2YWlsYWJsZU5vZGVSBW5vZGVz');
...
final $typed_data.Uint8List availableNodeDescriptor = $convert.base64Decode(
    'Cg1BdmFpbGFibGVOb2RlEi4KBHR5cGUYASABKA4yGi5taXplci5ub2Rlcy5Ob2RlLk5vZGVUeXBlUgR0eXBlEhIKBG5hbWUYAiABKAlSBG5hbWUSNQoIY2F0ZWdvcnkYAyABKA4yGS5taXplci5ub2Rlcy5Ob2RlQ2F0ZWdvcnlSCGNhdGVnb3J5');
...
final $typed_data.Uint8List nodeConnectionDescriptor = $convert.base64Decode(
    '');
...
const Node$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.mizer.nodes.Node.NodePreviewType',
      '10': 'preview'
    },
...
const Node_NodeType$json = const {
  ...
  '2': const [
    ...
    const {'1': 'BEATS', '2': 85},
    const {'1': 'PRO_DJ_LINK_CLOCK', '2': 86},
    const {'1': 'PIONEER_CDJ', '2': 87},
    const {'1': 'NDI_OUTPUT', '2': 88},
...
final $typed_data.Uint8List nodeDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List nodeDetailsDescriptor = $convert.base64Decode(
    'CgtOb2RlRGV0YWlscxISCgRuYW1lGAEgASgJUgRuYW1lEjUKCGNhdGVnb3J5GAIgASgOMhkubWl6ZXIubm9kZXMuTm9kZUNhdGVnb3J5UghjYXRlZ29yeQ==');
...
const NodeConfig$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.mizer.nodes.ContainerNodeConfig',
      '9': 0,
      '10': 'containerConfig'
    },
  ],
...
final $typed_data.Uint8List nodeConfigDescriptor = $convert.base64Decode(
    'CgpOb2RlQ29uZmlnEk0KEGNvbnRhaW5lcl9jb25maWcYLSABKAsyIC5taXplci5ub2Rlcy5Db250YWluZXJOb2RlQ29uZmlnSABSD2NvbnRhaW5lckNvbmZpZ0IGCgR0eXBl');
...
const NodeSetting$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.mizer.nodes.NodeSetting.TextValue',
      '9': 0,
      '10': 'text'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.mizer.nodes.NodeSetting.FloatValue',
      '9': 0,
      '10': 'float'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.mizer.nodes.NodeSetting.IntValue',
      '9': 0,
      '10': 'int'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.mizer.nodes.NodeSetting.BoolValue',
      '9': 0,
      '10': 'bool'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.mizer.nodes.NodeSetting.SelectValue',
      '9': 0,
      '10': 'select'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.mizer.nodes.NodeSetting.EnumValue',
      '9': 0,
      '10': 'enum'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.mizer.nodes.NodeSetting.IdValue',
      '9': 0,
      '10': 'id'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.mizer.nodes.NodeSetting.SplineValue',
      '9': 0,
      '10': 'spline'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.mizer.nodes.NodeSetting.MediaValue',
      '9': 0,
      '10': 'media'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.mizer.nodes.NodeSetting.UintValue',
      '9': 0,
      '10': 'uint'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.mizer.nodes.NodeSetting.StepSequencerValue',
      '9': 0,
      '10': 'stepSequencer'
    },
  ],
  '3': const [
    NodeSetting_TextValue$json,
    NodeSetting_FloatValue$json,
    NodeSetting_IntValue$json,
    NodeSetting_UintValue$json,
    NodeSetting_BoolValue$json,
    NodeSetting_SelectValue$json,
    NodeSetting_SelectVariant$json,
    NodeSetting_EnumValue$json,
    NodeSetting_EnumVariant$json,
    NodeSetting_IdValue$json,
    NodeSetting_IdVariant$json,
    NodeSetting_SplineValue$json,
    NodeSetting_MediaValue$json,
    NodeSetting_StepSequencerValue$json
  ],
  '8': const [
    const {'1': 'value'},
  ],
...
const NodeSetting_SelectValue$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.mizer.nodes.NodeSetting.SelectVariant',
      '10': 'variants'
    },
  ],
};
...
const NodeSetting_SelectVariant$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.mizer.nodes.NodeSetting.SelectVariant.SelectGroup',
      '9': 0,
      '10': 'group'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.mizer.nodes.NodeSetting.SelectVariant.SelectItem',
      '9': 0,
      '10': 'item'
    },
  ],
  '3': const [
    NodeSetting_SelectVariant_SelectGroup$json,
    NodeSetting_SelectVariant_SelectItem$json
  ],
  '8': const [
    const {'1': 'variant'},
  ],
...
const NodeSetting_EnumValue$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.mizer.nodes.NodeSetting.EnumVariant',
      '10': 'variants'
    },
  ],
};
...
const NodeSetting_IdValue$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.mizer.nodes.NodeSetting.IdVariant',
      '10': 'variants'
    },
  ],
};
...
const NodeSetting_SplineValue$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.mizer.nodes.NodeSetting.SplineValue.SplineStep',
      '10': 'steps'
    },
  ],
...
const MidiNodeConfig$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.mizer.nodes.MidiNodeConfig.NoteBinding',
      '9': 0,
      '10': 'noteBinding'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.mizer.nodes.MidiNodeConfig.ControlBinding',
      '9': 0,
      '10': 'controlBinding'
    },
  ],
...
const MidiNodeConfig_NoteBinding$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.mizer.nodes.MidiNodeConfig.NoteBinding.MidiType',
      '10': 'type'
    },
...
final $typed_data.Uint8List midiNodeConfigDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List containerNodeConfigDescriptor = $convert.base64Decode(
    'ChNDb250YWluZXJOb2RlQ29uZmlnEicKBW5vZGVzGAEgAygLMhEubWl6ZXIubm9kZXMuTm9kZVIFbm9kZXM=');
...
final $typed_data.Uint8List nodePositionDescriptor =
    $convert.base64Decode('CgxOb2RlUG9zaXRpb24SDAoBeBgBIAEoAVIBeBIMCgF5GAIgASgBUgF5');
...
final $typed_data.Uint8List nodeDesignerDescriptor = $convert.base64Decode(
    'CgxOb2RlRGVzaWduZXISNQoIcG9zaXRpb24YASABKAsyGS5taXplci5ub2Rlcy5Ob2RlUG9zaXRpb25SCHBvc2l0aW9uEhQKBXNjYWxlGAIgASgBUgVzY2FsZRIWCgZoaWRkZW4YAyABKAhSBmhpZGRlbg==');
...
final $typed_data.Uint8List portDescriptor = $convert.base64Decode(
    'CgRQb3J0EhIKBG5hbWUYASABKAlSBG5hbWUSOAoIcHJvdG9jb2wYAiABKA4yHC5taXplci5ub2Rlcy5DaGFubmVsUHJvdG9jb2xSCHByb3RvY29sEhoKCG11bHRpcGxlGAMgASgIUghtdWx0aXBsZQ==');
