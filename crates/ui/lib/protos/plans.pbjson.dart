...
final $typed_data.Uint8List moveFixturesRequestDescriptor = $convert.base64Decode('ChNNb3ZlRml4dHVyZXNSZXF1ZXN0EhcKB3BsYW5faWQYASABKAlSBnBsYW5JZBIMCgF4GAIgASgBUgF4EgwKAXkYAyABKAFSAXk=');
@$core.Deprecated('Use transformFixturesRequestDescriptor instead')
const TransformFixturesRequest$json = const {
  '1': 'TransformFixturesRequest',
  '2': const [
    const {'1': 'plan_id', '3': 1, '4': 1, '5': 9, '10': 'planId'},
    const {'1': 'rotation', '3': 2, '4': 1, '5': 1, '10': 'rotation'},
  ],
};

/// Descriptor for `TransformFixturesRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List transformFixturesRequestDescriptor = $convert.base64Decode('ChhUcmFuc2Zvcm1GaXh0dXJlc1JlcXVlc3QSFwoHcGxhbl9pZBgBIAEoCVIGcGxhbklkEhoKCHJvdGF0aW9uGAIgASgBUghyb3RhdGlvbg==');
...
const SpreadFixturesRequest$json = const {
  '1': 'SpreadFixturesRequest',
  '2': const [
    const {'1': 'plan_id', '3': 1, '4': 1, '5': 9, '10': 'planId'},
    const {'1': 'geometry', '3': 2, '4': 1, '5': 14, '6': '.mizer.plans.SpreadFixturesRequest.SpreadGeometry', '10': 'geometry'},
  ],
  '4': const [SpreadFixturesRequest_SpreadGeometry$json],
};

@$core.Deprecated('Use spreadFixturesRequestDescriptor instead')
const SpreadFixturesRequest_SpreadGeometry$json = const {
  '1': 'SpreadGeometry',
  '2': const [
    const {'1': 'SQUARE', '2': 0},
...
final $typed_data.Uint8List spreadFixturesRequestDescriptor = $convert.base64Decode('ChVTcHJlYWRGaXh0dXJlc1JlcXVlc3QSFwoHcGxhbl9pZBgBIAEoCVIGcGxhbklkEk0KCGdlb21ldHJ5GAIgASgOMjEubWl6ZXIucGxhbnMuU3ByZWFkRml4dHVyZXNSZXF1ZXN0LlNwcmVhZEdlb21ldHJ5UghnZW9tZXRyeSI2Cg5TcHJlYWRHZW9tZXRyeRIKCgZTUVVBUkUQABIMCghUUklBTkdMRRABEgoKBkNJUkNMRRAC');
...
final $typed_data.Uint8List moveFixtureRequestDescriptor = $convert.base64Decode('ChJNb3ZlRml4dHVyZVJlcXVlc3QSFwoHcGxhbl9pZBgBIAEoCVIGcGxhbklkEjgKCmZpeHR1cmVfaWQYAiABKAsyGS5taXplci5maXh0dXJlcy5GaXh0dXJlSWRSCWZpeHR1cmVJZBIMCgF4GAMgASgBUgF4EgwKAXkYBCABKAFSAXk=');
...
const AddScreenRequest$json = const {
  '1': 'AddScreenRequest',
  '2': const [
    const {'1': 'plan_id', '3': 1, '4': 1, '5': 9, '10': 'planId'},
    const {'1': 'x', '3': 2, '4': 1, '5': 1, '10': 'x'},
...
final $typed_data.Uint8List addScreenRequestDescriptor = $convert.base64Decode('ChBBZGRTY3JlZW5SZXF1ZXN0EhcKB3BsYW5faWQYASABKAlSBnBsYW5JZBIMCgF4GAIgASgBUgF4EgwKAXkYAyABKAFSAXkSFAoFd2lkdGgYBCABKAFSBXdpZHRoEhYKBmhlaWdodBgFIAEoAVIGaGVpZ2h0');
...
final $typed_data.Uint8List fixturePositionDescriptor = $convert.base64Decode('Cg9GaXh0dXJlUG9zaXRpb24SKQoCaWQYASABKAsyGS5taXplci5maXh0dXJlcy5GaXh0dXJlSWRSAmlkEgwKAXgYAiABKAFSAXgSDAoBeRgDIAEoAVIBeRIUCgV3aWR0aBgEIAEoAVIFd2lkdGgSFgoGaGVpZ2h0GAUgASgBUgZoZWlnaHQ=');
...
final $typed_data.Uint8List planScreenDescriptor = $convert.base64Decode('CgpQbGFuU2NyZWVuEg4KAmlkGAEgASgNUgJpZBIMCgF4GAIgASgBUgF4EgwKAXkYAyABKAFSAXkSFAoFd2lkdGgYBCABKAFSBXdpZHRoEhYKBmhlaWdodBgFIAEoAVIGaGVpZ2h0');
