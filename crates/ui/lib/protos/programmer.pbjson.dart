...
const StoreGroupMode$json = {
  '1': 'StoreGroupMode',
  '2': [
    {'1': 'STORE_GROUP_MODE_OVERWRITE', '2': 0},
    {'1': 'STORE_GROUP_MODE_MERGE', '2': 1},
    {'1': 'STORE_GROUP_MODE_SUBTRACT', '2': 2},
  ],
};

/// Descriptor for `StoreGroupMode`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List storeGroupModeDescriptor = $convert.base64Decode(
    'Cg5TdG9yZUdyb3VwTW9kZRIeChpTVE9SRV9HUk9VUF9NT0RFX09WRVJXUklURRAAEhoKFlNUT1'
    'JFX0dST1VQX01PREVfTUVSR0UQARIdChlTVE9SRV9HUk9VUF9NT0RFX1NVQlRSQUNUEAI=');
...
const ProgrammerChannel$json = {
  ...
  '2': [
    ...
    {'1': 'direct', '3': 3, '4': 1, '5': 11, '6': '.mizer.fixtures.FixtureValue', '9': 0, '10': 'direct'},
    {'1': 'preset', '3': 4, '4': 1, '5': 11, '6': '.mizer.programmer.PresetId', '9': 0, '10': 'preset'},
  ],
  '8': [
    {'1': 'value'},
  ],
...
final $typed_data.Uint8List programmerChannelDescriptor = $convert.base64Decode(
    ...
    'ZpeHR1cmVJZFIIZml4dHVyZXMSGAoHY29udHJvbBgCIAEoCVIHY29udHJvbBI2CgZkaXJlY3QY'
    'AyABKAsyHC5taXplci5maXh0dXJlcy5GaXh0dXJlVmFsdWVIAFIGZGlyZWN0EjQKBnByZXNldB'
    'gEIAEoCzIaLm1pemVyLnByb2dyYW1tZXIuUHJlc2V0SWRIAFIGcHJlc2V0QgcKBXZhbHVl');
...
final $typed_data.Uint8List writeControlRequestDescriptor = $convert.base64Decode(
    'ChNXcml0ZUNvbnRyb2xSZXF1ZXN0EhgKB2NvbnRyb2wYASABKAlSB2NvbnRyb2wSGgoHcGVyY2'
    'VudBgCIAEoAUgAUgdwZXJjZW50QgcKBXZhbHVl');
...
const AssignFixturesToGroupRequest$json = {
  ...
  '2': [
    ...
    {'1': 'mode', '3': 3, '4': 1, '5': 14, '6': '.mizer.programmer.StoreGroupMode', '10': 'mode'},
  ],
};
...
final $typed_data.Uint8List assignFixturesToGroupRequestDescriptor = $convert.base64Decode(
    ...
    'JlcxgCIAMoCzIZLm1pemVyLmZpeHR1cmVzLkZpeHR1cmVJZFIIZml4dHVyZXMSNAoEbW9kZRgD'
    'IAEoDjIgLm1pemVyLnByb2dyYW1tZXIuU3RvcmVHcm91cE1vZGVSBG1vZGU=');
...
const AssignFixtureSelectionToGroupRequest$json = {
  ...
  '2': [
    {'1': 'id', '3': 1, '4': 1, '5': 13, '10': 'id'},
    {'1': 'mode', '3': 2, '4': 1, '5': 14, '6': '.mizer.programmer.StoreGroupMode', '10': 'mode'},
  ],
};
...
final $typed_data.Uint8List assignFixtureSelectionToGroupRequestDescriptor = $convert.base64Decode(
    'CiRBc3NpZ25GaXh0dXJlU2VsZWN0aW9uVG9Hcm91cFJlcXVlc3QSDgoCaWQYASABKA1SAmlkEj'
    'QKBG1vZGUYAiABKA4yIC5taXplci5wcm9ncmFtbWVyLlN0b3JlR3JvdXBNb2RlUgRtb2Rl');
