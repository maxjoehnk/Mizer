...
const PresetTarget$json = const {
  '1': 'PresetTarget',
  '2': const [
    const {'1': 'PRESET_TARGET_UNIVERSAL', '2': 0},
    const {'1': 'PRESET_TARGET_SELECTIVE', '2': 1},
  ],
};

/// Descriptor for `PresetTarget`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List presetTargetDescriptor = $convert.base64Decode('CgxQcmVzZXRUYXJnZXQSGwoXUFJFU0VUX1RBUkdFVF9VTklWRVJTQUwQABIbChdQUkVTRVRfVEFSR0VUX1NFTEVDVElWRRAB');
@$core.Deprecated('Use storeGroupModeDescriptor instead')
const StoreGroupMode$json = const {
  '1': 'StoreGroupMode',
  '2': const [
    const {'1': 'STORE_GROUP_MODE_OVERWRITE', '2': 0},
    const {'1': 'STORE_GROUP_MODE_MERGE', '2': 1},
    const {'1': 'STORE_GROUP_MODE_SUBTRACT', '2': 2},
  ],
};

/// Descriptor for `StoreGroupMode`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List storeGroupModeDescriptor = $convert.base64Decode('Cg5TdG9yZUdyb3VwTW9kZRIeChpTVE9SRV9HUk9VUF9NT0RFX09WRVJXUklURRAAEhoKFlNUT1JFX0dST1VQX01PREVfTUVSR0UQARIdChlTVE9SRV9HUk9VUF9NT0RFX1NVQlRSQUNUEAI=');
...
const ProgrammerState$json = const {
  ...
  '2': const [
    ...
    const {'1': 'offline', '3': 11, '4': 1, '5': 8, '10': 'offline'},
    const {'1': 'fixture_values', '3': 12, '4': 3, '5': 11, '6': '.mizer.programmer.FixtureValue', '10': 'fixtureValues'},
  ],
};

/// Descriptor for `ProgrammerState`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List programmerStateDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use fixtureValueDescriptor instead')
const FixtureValue$json = const {
  '1': 'FixtureValue',
  '2': const [
    const {'1': 'fixture', '3': 1, '4': 1, '5': 11, '6': '.mizer.fixtures.FixtureId', '10': 'fixture'},
    const {'1': 'intensity', '3': 2, '4': 1, '5': 1, '9': 0, '10': 'intensity', '17': true},
    const {'1': 'color', '3': 3, '4': 1, '5': 11, '6': '.mizer.fixtures.ColorMixerChannel', '9': 1, '10': 'color', '17': true},
    const {'1': 'pan', '3': 4, '4': 1, '5': 1, '9': 2, '10': 'pan', '17': true},
    const {'1': 'tilt', '3': 5, '4': 1, '5': 1, '9': 3, '10': 'tilt', '17': true},
  ],
  '8': const [
    const {'1': '_intensity'},
    const {'1': '_color'},
...
final $typed_data.Uint8List fixtureValueDescriptor = $convert.base64Decode('');
...
const ProgrammerChannel$json = const {
  ...
  '2': const [
    ...
    const {'1': 'preset', '3': 6, '4': 1, '5': 11, '6': '.mizer.programmer.PresetId', '9': 0, '10': 'preset'},
  ],
...
final $typed_data.Uint8List programmerChannelDescriptor = $convert.base64Decode('');
...
const StoreRequest_Mode$json = const {
  ...
  '2': const [
    ...
    const {'1': 'MERGE', '2': 1},
    const {'1': 'ADD_CUE', '2': 2},
    const {'1': 'INSERT_CUE', '2': 3},
  ],
};

/// Descriptor for `StoreRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List storeRequestDescriptor = $convert.base64Decode('');
...
const StorePresetRequest_NewPreset$json = const {
  ...
  '2': const [
    ...
    const {'1': 'target', '3': 2, '4': 1, '5': 14, '6': '.mizer.programmer.PresetTarget', '9': 0, '10': 'target', '17': true},
...
final $typed_data.Uint8List storePresetRequestDescriptor = $convert.base64Decode('');
...
const Preset$json = const {
  ...
  '2': const [
    const {'1': 'id', '3': 1, '4': 1, '5': 11, '6': '.mizer.programmer.PresetId', '10': 'id'},
    const {'1': 'target', '3': 2, '4': 1, '5': 14, '6': '.mizer.programmer.PresetTarget', '10': 'target'},
    const {'1': 'label', '3': 3, '4': 1, '5': 9, '9': 1, '10': 'label', '17': true},
...
final $typed_data.Uint8List presetDescriptor = $convert.base64Decode('');
...
const AssignFixturesToGroupRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'mode', '3': 3, '4': 1, '5': 14, '6': '.mizer.programmer.StoreGroupMode', '10': 'mode'},
  ],
};

/// Descriptor for `AssignFixturesToGroupRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List assignFixturesToGroupRequestDescriptor = $convert.base64Decode('ChxBc3NpZ25GaXh0dXJlc1RvR3JvdXBSZXF1ZXN0Eg4KAmlkGAEgASgNUgJpZBI1CghmaXh0dXJlcxgCIAMoCzIZLm1pemVyLmZpeHR1cmVzLkZpeHR1cmVJZFIIZml4dHVyZXMSNAoEbW9kZRgDIAEoDjIgLm1pemVyLnByb2dyYW1tZXIuU3RvcmVHcm91cE1vZGVSBG1vZGU=');
...
const AssignFixtureSelectionToGroupRequest$json = const {
  ...
  '2': const [
    const {'1': 'id', '3': 1, '4': 1, '5': 13, '10': 'id'},
    const {'1': 'mode', '3': 2, '4': 1, '5': 14, '6': '.mizer.programmer.StoreGroupMode', '10': 'mode'},
  ],
};

/// Descriptor for `AssignFixtureSelectionToGroupRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List assignFixtureSelectionToGroupRequestDescriptor = $convert.base64Decode('CiRBc3NpZ25GaXh0dXJlU2VsZWN0aW9uVG9Hcm91cFJlcXVlc3QSDgoCaWQYASABKA1SAmlkEjQKBG1vZGUYAiABKA4yIC5taXplci5wcm9ncmFtbWVyLlN0b3JlR3JvdXBNb2RlUgRtb2Rl');
