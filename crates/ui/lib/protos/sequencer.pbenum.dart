...
class FixturePriority extends $pb.ProtobufEnum {
  static const FixturePriority PRIORITY_HTP = FixturePriority._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PRIORITY_HTP');
  static const FixturePriority PRIORITY_LTP_HIGHEST = FixturePriority._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PRIORITY_LTP_HIGHEST');
  static const FixturePriority PRIORITY_LTP_HIGH = FixturePriority._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PRIORITY_LTP_HIGH');
  static const FixturePriority PRIORITY_LTP_NORMAL = FixturePriority._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PRIORITY_LTP_NORMAL');
  static const FixturePriority PRIORITY_LTP_LOW = FixturePriority._(4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PRIORITY_LTP_LOW');
  static const FixturePriority PRIORITY_LTP_LOWEST = FixturePriority._(5, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PRIORITY_LTP_LOWEST');
