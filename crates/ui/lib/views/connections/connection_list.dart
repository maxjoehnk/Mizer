...
class ConnectionList extends StatefulWidget {
  ...
  final List<MidiDeviceProfile> midiDeviceProfiles;
  final Function() onRefresh;

  const ConnectionList({required this.connections, required this.midiDeviceProfiles, required this.onRefresh, super.key});
