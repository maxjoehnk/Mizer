...
pub enum CommandImpl {
    ...
    AlignFixturesInPlanCommand(AlignFixturesInPlanCommand),
...
impl CommandImpl {
    pub(crate) fn apply(
        ...
        match &self {
            ...
            Self::AlignFixturesInPlanCommand(cmd) => self._apply(injector, executor, cmd),
    ...
    pub(crate) fn revert(
        ...
        match &self {
            ...
            Self::AlignFixturesInPlanCommand(cmd) => executor.revert(injector, cmd),
    ...
    pub fn label(&self) -> String {
        match self {
            ...
            Self::AlignFixturesInPlanCommand(cmd) => cmd.label(),
