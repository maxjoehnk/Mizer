...
use mizer_node::{NodeLink, PortType, NodePath, ProcessingNode};
...
fn run_pipeline_with_node<P: Into<NodePath> + 'static, N: ProcessingNode + 'static>(path: P, node: N, frames: usize) {
    let path = path.into();
