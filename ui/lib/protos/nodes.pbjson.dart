...
final $typed_data.Uint8List nodeDescriptor = $convert.base64Decode('');
...
const NodeConfig$json = const {
  ...
  '2': const [
    ...
    const {'1': 'mqttInputConfig', '3': 47, '4': 1, '5': 11, '6': '.mizer.MqttInputNodeConfig', '9': 0, '10': 'mqttInputConfig'},
    const {'1': 'mqttOutputConfig', '3': 48, '4': 1, '5': 11, '6': '.mizer.MqttOutputNodeConfig', '9': 0, '10': 'mqttOutputConfig'},
    const {'1': 'numberToDataConfig', '3': 49, '4': 1, '5': 11, '6': '.mizer.NumberToDataNodeConfig', '9': 0, '10': 'numberToDataConfig'},
    const {'1': 'dataToNumberConfig', '3': 50, '4': 1, '5': 11, '6': '.mizer.DataToNumberNodeConfig', '9': 0, '10': 'dataToNumberConfig'},
    const {'1': 'valueConfig', '3': 51, '4': 1, '5': 11, '6': '.mizer.ValueNodeConfig', '9': 0, '10': 'valueConfig'},
    const {'1': 'planScreenConfig', '3': 52, '4': 1, '5': 11, '6': '.mizer.PlanScreenNodeConfig', '9': 0, '10': 'planScreenConfig'},
    const {'1': 'videoPixelFileConfig', '3': 53, '4': 1, '5': 11, '6': '.mizer.VideoPixelFileNodeConfig', '9': 0, '10': 'videoPixelFileConfig'},
  ],
  '8': const [
    const {'1': 'type'},
  ],
...
final $typed_data.Uint8List nodeConfigDescriptor = $convert.base64Decode('');
...
@$core.Deprecated('Use videoPixelFileNodeConfigDescriptor instead')
const VideoPixelFileNodeConfig$json = const {
  '1': 'VideoPixelFileNodeConfig',
  '2': const [
    const {'1': 'file_path', '3': 1, '4': 1, '5': 9, '10': 'filePath'},
  ],
};

/// Descriptor for `VideoPixelFileNodeConfig`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List videoPixelFileNodeConfigDescriptor = $convert.base64Decode('ChhWaWRlb1BpeGVsRmlsZU5vZGVDb25maWcSGwoJZmlsZV9wYXRoGAEgASgJUghmaWxlUGF0aA==');
