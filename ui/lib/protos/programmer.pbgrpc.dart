...
class ProgrammerApiClient extends $grpc.Client {
  ...
  static final _$writeControl = $grpc.ClientMethod<$1.WriteControlRequest, $1.WriteControlResponse>(
      '/mizer.programmer.ProgrammerApi/WriteControl',
      ($1.WriteControlRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.WriteControlResponse.fromBuffer(value));
  static final _$selectFixtures =
      $grpc.ClientMethod<$1.SelectFixturesRequest, $1.SelectFixturesResponse>(
          ...
          ($core.List<$core.int> value) => $1.SelectFixturesResponse.fromBuffer(value));
  static final _$unselectFixtures =
      $grpc.ClientMethod<$1.UnselectFixturesRequest, $1.UnselectFixturesResponse>(
          '/mizer.programmer.ProgrammerApi/UnselectFixtures',
          ($1.UnselectFixturesRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $1.UnselectFixturesResponse.fromBuffer(value));
  ...
  static final _$highlight = $grpc.ClientMethod<$1.HighlightRequest, $1.HighlightResponse>(
      '/mizer.programmer.ProgrammerApi/Highlight',
      ($1.HighlightRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.HighlightResponse.fromBuffer(value));
  ...
  static final _$callPreset = $grpc.ClientMethod<$1.PresetId, $1.CallPresetResponse>(
      '/mizer.programmer.ProgrammerApi/CallPreset',
      ($1.PresetId value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.CallPresetResponse.fromBuffer(value));
  ...
  static final _$selectGroup = $grpc.ClientMethod<$1.SelectGroupRequest, $1.SelectGroupResponse>(
      '/mizer.programmer.ProgrammerApi/SelectGroup',
      ($1.SelectGroupRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.SelectGroupResponse.fromBuffer(value));
  ...
  static final _$assignFixturesToGroup =
      $grpc.ClientMethod<$1.AssignFixturesToGroupRequest, $1.AssignFixturesToGroupResponse>(
          '/mizer.programmer.ProgrammerApi/AssignFixturesToGroup',
          ($1.AssignFixturesToGroupRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $1.AssignFixturesToGroupResponse.fromBuffer(value));
  static final _$assignFixtureSelectionToGroup =
      $grpc.ClientMethod<$1.AssignFixtureSelectionToGroupRequest, $1.AssignFixturesToGroupResponse>(
  ...
  static final _$writeEffectRate =
      $grpc.ClientMethod<$1.WriteEffectRateRequest, $1.WriteEffectRateResponse>(
          ...
          ($core.List<$core.int> value) => $1.WriteEffectRateResponse.fromBuffer(value));
  static final _$writeEffectOffset =
      $grpc.ClientMethod<$1.WriteEffectOffsetRequest, $1.WriteEffectOffsetResponse>(
          '/mizer.programmer.ProgrammerApi/WriteEffectOffset',
          ($1.WriteEffectOffsetRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $1.WriteEffectOffsetResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$1.WriteControlResponse> writeControl($1.WriteControlRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$writeControl, request, options: options);
  }

  $grpc.ResponseFuture<$1.SelectFixturesResponse> selectFixtures($1.SelectFixturesRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$1.HighlightResponse> highlight($1.HighlightRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$1.SelectGroupResponse> selectGroup($1.SelectGroupRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$1.AssignFixturesToGroupResponse> assignFixtureSelectionToGroup(
      $1.AssignFixtureSelectionToGroupRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$assignFixtureSelectionToGroup, request, options: options);
  }
...
abstract class ProgrammerApiServiceBase extends $grpc.Service {
  ...
  ProgrammerApiServiceBase() {
    $addMethod($grpc.ServiceMethod<$1.SubscribeProgrammerRequest, $1.ProgrammerState>(
        'SubscribeToProgrammer',
        subscribeToProgrammer_Pre,
        false,
        true,
        ($core.List<$core.int> value) => $1.SubscribeProgrammerRequest.fromBuffer(value),
        ($1.ProgrammerState value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.WriteControlRequest, $1.WriteControlResponse>(
        'WriteControl',
        writeControl_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $1.WriteControlRequest.fromBuffer(value),
        ($1.WriteControlResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.SelectFixturesRequest, $1.SelectFixturesResponse>(
        'SelectFixtures',
        selectFixtures_Pre,
        false,
        false,
    ...
    $addMethod($grpc.ServiceMethod<$1.UnselectFixturesRequest, $1.UnselectFixturesResponse>(
        'UnselectFixtures',
    ...
    $addMethod($grpc.ServiceMethod<$1.SelectGroupRequest, $1.SelectGroupResponse>(
        'SelectGroup',
        selectGroup_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $1.SelectGroupRequest.fromBuffer(value),
    ...
    $addMethod(
        $grpc.ServiceMethod<$1.AssignFixturesToGroupRequest, $1.AssignFixturesToGroupResponse>(
            'AssignFixturesToGroup',
            assignFixturesToGroup_Pre,
            false,
            false,
            ($core.List<$core.int> value) => $1.AssignFixturesToGroupRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$1.AssignFixtureSelectionToGroupRequest,
        ...
        false,
        false,
        ($core.List<$core.int> value) => $1.AssignFixtureSelectionToGroupRequest.fromBuffer(value),
        ($1.AssignFixturesToGroupResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.WriteEffectRateRequest, $1.WriteEffectRateResponse>(
        'WriteEffectRate',
        writeEffectRate_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $1.WriteEffectRateRequest.fromBuffer(value),
        ($1.WriteEffectRateResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.WriteEffectOffsetRequest, $1.WriteEffectOffsetResponse>(
        'WriteEffectOffset',
        writeEffectOffset_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $1.WriteEffectOffsetRequest.fromBuffer(value),
        ($1.WriteEffectOffsetResponse value) => value.writeToBuffer()));
  }

  $async.Stream<$1.ProgrammerState> subscribeToProgrammer_Pre(
      $grpc.ServiceCall call, $async.Future<$1.SubscribeProgrammerRequest> request) async* {
    yield* subscribeToProgrammer(call, await request);
  }

  $async.Future<$1.WriteControlResponse> writeControl_Pre(
      $grpc.ServiceCall call, $async.Future<$1.WriteControlRequest> request) async {
  ...
  $async.Future<$1.HighlightResponse> highlight_Pre(
  ...
  $async.Future<$1.SelectGroupResponse> selectGroup_Pre(
      $grpc.ServiceCall call, $async.Future<$1.SelectGroupRequest> request) async {
  ...
  $async.Future<$1.AssignFixturesToGroupResponse> assignFixturesToGroup_Pre(
      $grpc.ServiceCall call, $async.Future<$1.AssignFixturesToGroupRequest> request) async {
    return assignFixturesToGroup(call, await request);
  }

  $async.Future<$1.AssignFixturesToGroupResponse> assignFixtureSelectionToGroup_Pre(
      $grpc.ServiceCall call,
      $async.Future<$1.AssignFixtureSelectionToGroupRequest> request) async {
    return assignFixtureSelectionToGroup(call, await request);
  }

  $async.Future<$1.WriteEffectRateResponse> writeEffectRate_Pre(
      $grpc.ServiceCall call, $async.Future<$1.WriteEffectRateRequest> request) async {
    return writeEffectRate(call, await request);
  }

  $async.Future<$1.WriteEffectOffsetResponse> writeEffectOffset_Pre(
      $grpc.ServiceCall call, $async.Future<$1.WriteEffectOffsetRequest> request) async {
  ...
  $async.Future<$1.ClearResponse> clear($grpc.ServiceCall call, $1.ClearRequest request);
  $async.Future<$1.HighlightResponse> highlight(
      $grpc.ServiceCall call, $1.HighlightRequest request);
  $async.Future<$1.StoreResponse> store($grpc.ServiceCall call, $1.StoreRequest request);
  $async.Future<$1.Presets> getPresets($grpc.ServiceCall call, $1.PresetsRequest request);
  $async.Future<$1.CallPresetResponse> callPreset($grpc.ServiceCall call, $1.PresetId request);
  $async.Future<$1.Groups> getGroups($grpc.ServiceCall call, $1.GroupsRequest request);
  $async.Future<$1.SelectGroupResponse> selectGroup(
      $grpc.ServiceCall call, $1.SelectGroupRequest request);
  $async.Future<$1.Group> addGroup($grpc.ServiceCall call, $1.AddGroupRequest request);
