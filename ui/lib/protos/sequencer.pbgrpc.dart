...
class SequencerApiClient extends $grpc.Client {
  static final _$getSequences = $grpc.ClientMethod<$1.GetSequencesRequest, $1.Sequences>(
  ...
  static final _$getSequence = $grpc.ClientMethod<$1.GetSequenceRequest, $1.Sequence>(
  ...
  static final _$addSequence = $grpc.ClientMethod<$1.AddSequenceRequest, $1.Sequence>(
      '/mizer.sequencer.SequencerApi/AddSequence',
      ($1.AddSequenceRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.Sequence.fromBuffer(value));
  static final _$deleteSequence = $grpc.ClientMethod<$1.DeleteSequenceRequest, $1.Sequences>(
      '/mizer.sequencer.SequencerApi/DeleteSequence',
      ($1.DeleteSequenceRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.Sequences.fromBuffer(value));
  static final _$sequenceGo = $grpc.ClientMethod<$1.SequenceGoRequest, $1.EmptyResponse>(
  ...
  static final _$sequenceStop = $grpc.ClientMethod<$1.SequenceStopRequest, $1.EmptyResponse>(
      '/mizer.sequencer.SequencerApi/SequenceStop',
      ($1.SequenceStopRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.EmptyResponse.fromBuffer(value));
  static final _$updateCueTrigger = $grpc.ClientMethod<$1.CueTriggerRequest, $1.Sequences>(
      '/mizer.sequencer.SequencerApi/UpdateCueTrigger',
      ($1.CueTriggerRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.Sequences.fromBuffer(value));
  static final _$updateCueTriggerTime = $grpc.ClientMethod<$1.CueTriggerTimeRequest, $1.Sequences>(
      '/mizer.sequencer.SequencerApi/UpdateCueTriggerTime',
      ($1.CueTriggerTimeRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.Sequences.fromBuffer(value));
  static final _$updateCueEffectOffsetTime =
      $grpc.ClientMethod<$1.CueEffectOffsetTimeRequest, $1.Sequences>(
          '/mizer.sequencer.SequencerApi/UpdateCueEffectOffsetTime',
          ($1.CueEffectOffsetTimeRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $1.Sequences.fromBuffer(value));
  static final _$updateCueName = $grpc.ClientMethod<$1.CueNameRequest, $1.Sequences>(
      '/mizer.sequencer.SequencerApi/UpdateCueName',
      ($1.CueNameRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.Sequences.fromBuffer(value));
  static final _$updateCueValue = $grpc.ClientMethod<$1.CueValueRequest, $1.Sequences>(
      '/mizer.sequencer.SequencerApi/UpdateCueValue',
      ($1.CueValueRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.Sequences.fromBuffer(value));
  static final _$updateCueFadeTime = $grpc.ClientMethod<$1.CueTimingRequest, $1.Sequences>(
      '/mizer.sequencer.SequencerApi/UpdateCueFadeTime',
      ($1.CueTimingRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.Sequences.fromBuffer(value));
  static final _$updateCueDelayTime = $grpc.ClientMethod<$1.CueTimingRequest, $1.Sequences>(
  ...
  static final _$updateSequenceStopOnLastCue =
      $grpc.ClientMethod<$1.SequenceStopOnLastCueRequest, $1.Sequences>(
          ...
          ($core.List<$core.int> value) => $1.Sequences.fromBuffer(value));
  static final _$updateSequenceName = $grpc.ClientMethod<$1.CueNameRequest, $1.Sequences>(
  ...
  $grpc.ResponseFuture<$1.Sequences> getSequences($1.GetSequencesRequest request,
  ...
  $grpc.ResponseFuture<$1.Sequences> deleteSequence($1.DeleteSequenceRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$deleteSequence, request, options: options);
  }

  $grpc.ResponseFuture<$1.EmptyResponse> sequenceGo($1.SequenceGoRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$sequenceGo, request, options: options);
  }

  $grpc.ResponseFuture<$1.EmptyResponse> sequenceStop($1.SequenceStopRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$sequenceStop, request, options: options);
  }

  $grpc.ResponseFuture<$1.Sequences> updateCueTrigger($1.CueTriggerRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$updateCueTrigger, request, options: options);
  }

  $grpc.ResponseFuture<$1.Sequences> updateCueTriggerTime($1.CueTriggerTimeRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$updateCueTriggerTime, request, options: options);
  }

  $grpc.ResponseFuture<$1.Sequences> updateCueEffectOffsetTime(
      $1.CueEffectOffsetTimeRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$updateCueEffectOffsetTime, request, options: options);
  }
  ...
  $grpc.ResponseFuture<$1.Sequences> updateCueFadeTime($1.CueTimingRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$updateCueFadeTime, request, options: options);
  }

  $grpc.ResponseFuture<$1.Sequences> updateCueDelayTime($1.CueTimingRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$updateCueDelayTime, request, options: options);
  }

  $grpc.ResponseFuture<$1.Sequences> updateSequenceWrapAround($1.SequenceWrapAroundRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$updateSequenceWrapAround, request, options: options);
  }

  $grpc.ResponseFuture<$1.Sequences> updateSequenceStopOnLastCue(
      $1.SequenceStopOnLastCueRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$updateSequenceStopOnLastCue, request, options: options);
  }

  $grpc.ResponseFuture<$1.Sequences> updateSequenceName($1.CueNameRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class SequencerApiServiceBase extends $grpc.Service {
  ...
  SequencerApiServiceBase() {
    $addMethod($grpc.ServiceMethod<$1.GetSequencesRequest, $1.Sequences>(
        ...
        false,
        false,
        ($core.List<$core.int> value) => $1.GetSequencesRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$1.GetSequenceRequest, $1.Sequence>(
        ...
        false,
        false,
        ($core.List<$core.int> value) => $1.GetSequenceRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$1.AddSequenceRequest, $1.Sequence>(
        ...
        false,
        false,
        ($core.List<$core.int> value) => $1.AddSequenceRequest.fromBuffer(value),
        ($1.Sequence value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.DeleteSequenceRequest, $1.Sequences>(
        ...
        false,
        false,
        ($core.List<$core.int> value) => $1.DeleteSequenceRequest.fromBuffer(value),
        ($1.Sequences value) => value.writeToBuffer()));
    ...
    $addMethod($grpc.ServiceMethod<$1.SequenceStopRequest, $1.EmptyResponse>(
        ...
        false,
        false,
        ($core.List<$core.int> value) => $1.SequenceStopRequest.fromBuffer(value),
        ($1.EmptyResponse value) => value.writeToBuffer()));
    ...
    $addMethod($grpc.ServiceMethod<$1.CueTriggerTimeRequest, $1.Sequences>(
        ...
        false,
        false,
        ($core.List<$core.int> value) => $1.CueTriggerTimeRequest.fromBuffer(value),
        ($1.Sequences value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.CueEffectOffsetTimeRequest, $1.Sequences>(
        'UpdateCueEffectOffsetTime',
        updateCueEffectOffsetTime_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $1.CueEffectOffsetTimeRequest.fromBuffer(value),
        ($1.Sequences value) => value.writeToBuffer()));
    ...
    $addMethod($grpc.ServiceMethod<$1.SequenceWrapAroundRequest, $1.Sequences>(
        ...
        false,
        false,
        ($core.List<$core.int> value) => $1.SequenceWrapAroundRequest.fromBuffer(value),
        ($1.Sequences value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.SequenceStopOnLastCueRequest, $1.Sequences>(
        'UpdateSequenceStopOnLastCue',
        updateSequenceStopOnLastCue_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $1.SequenceStopOnLastCueRequest.fromBuffer(value),
        ($1.Sequences value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.CueNameRequest, $1.Sequences>(
        'UpdateSequenceName',
  ...
  $async.Future<$1.Sequences> getSequences_Pre(
      $grpc.ServiceCall call, $async.Future<$1.GetSequencesRequest> request) async {
    return getSequences(call, await request);
  }

  $async.Future<$1.Sequence> getSequence_Pre(
      $grpc.ServiceCall call, $async.Future<$1.GetSequenceRequest> request) async {
    return getSequence(call, await request);
  }

  $async.Future<$1.Sequence> addSequence_Pre(
      $grpc.ServiceCall call, $async.Future<$1.AddSequenceRequest> request) async {
    return addSequence(call, await request);
  }

  $async.Future<$1.Sequences> deleteSequence_Pre(
      $grpc.ServiceCall call, $async.Future<$1.DeleteSequenceRequest> request) async {
    return deleteSequence(call, await request);
  }

  $async.Future<$1.EmptyResponse> sequenceGo_Pre(
      $grpc.ServiceCall call, $async.Future<$1.SequenceGoRequest> request) async {
    return sequenceGo(call, await request);
  }

  $async.Future<$1.EmptyResponse> sequenceStop_Pre(
      $grpc.ServiceCall call, $async.Future<$1.SequenceStopRequest> request) async {
    return sequenceStop(call, await request);
  }

  $async.Future<$1.Sequences> updateCueTrigger_Pre(
      $grpc.ServiceCall call, $async.Future<$1.CueTriggerRequest> request) async {
    return updateCueTrigger(call, await request);
  }

  $async.Future<$1.Sequences> updateCueTriggerTime_Pre(
      $grpc.ServiceCall call, $async.Future<$1.CueTriggerTimeRequest> request) async {
    return updateCueTriggerTime(call, await request);
  }

  $async.Future<$1.Sequences> updateCueEffectOffsetTime_Pre(
      $grpc.ServiceCall call, $async.Future<$1.CueEffectOffsetTimeRequest> request) async {
    return updateCueEffectOffsetTime(call, await request);
  }
  ...
  $async.Future<$1.Sequences> updateCueFadeTime_Pre(
      $grpc.ServiceCall call, $async.Future<$1.CueTimingRequest> request) async {
    return updateCueFadeTime(call, await request);
  }

  $async.Future<$1.Sequences> updateCueDelayTime_Pre(
      $grpc.ServiceCall call, $async.Future<$1.CueTimingRequest> request) async {
    return updateCueDelayTime(call, await request);
  }

  $async.Future<$1.Sequences> updateSequenceWrapAround_Pre(
      $grpc.ServiceCall call, $async.Future<$1.SequenceWrapAroundRequest> request) async {
    return updateSequenceWrapAround(call, await request);
  }

  $async.Future<$1.Sequences> updateSequenceStopOnLastCue_Pre(
      $grpc.ServiceCall call, $async.Future<$1.SequenceStopOnLastCueRequest> request) async {
  ...
  $async.Future<$1.Sequences> getSequences($grpc.ServiceCall call, $1.GetSequencesRequest request);
  $async.Future<$1.Sequence> getSequence($grpc.ServiceCall call, $1.GetSequenceRequest request);
  $async.Future<$1.Sequence> addSequence($grpc.ServiceCall call, $1.AddSequenceRequest request);
  $async.Future<$1.Sequences> deleteSequence(
      $grpc.ServiceCall call, $1.DeleteSequenceRequest request);
  $async.Future<$1.EmptyResponse> sequenceGo($grpc.ServiceCall call, $1.SequenceGoRequest request);
  ...
  $async.Future<$1.Sequences> updateCueEffectOffsetTime(
      $grpc.ServiceCall call, $1.CueEffectOffsetTimeRequest request);
  $async.Future<$1.Sequences> updateCueName($grpc.ServiceCall call, $1.CueNameRequest request);
  $async.Future<$1.Sequences> updateCueValue($grpc.ServiceCall call, $1.CueValueRequest request);
  ...
  $async.Future<$1.Sequences> updateSequenceName($grpc.ServiceCall call, $1.CueNameRequest request);
}
